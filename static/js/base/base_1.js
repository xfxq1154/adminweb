    ...
    $.fn.duxTable = function (options) {
        ...
        this.each(function () {
            ...
            $(table).find('.js-del').click(function () {
                ...
                var removediv = $(obj).attr('removeclass');
                if (removediv) {
                    div = $('.' + removediv);
                }
            ...
            $(table).find('.js-action').click(function () {
              ...
              //处理其他动作
            $(table).find('.js-open').click(function () {
            ...
            function operat(obj, url, success, failure) {
                Do.ready('tips', 'dialog', function () {
                    ...
                    var dialog = layer.confirm('你确认执行' + text + '操作？',{icon:2}, function () {
        ...
        this.each(function () {
            ...
            preview.click(function () {
                if (urlVal.val() == '') {
                    ...
                    window.open(duxConfig.upDir+urlVal.val());
                }
                return;
            });
            /*创建上传*/
