...
class StatcenterController extends Storebase{
    ...
    public function pagedetailAction(){
        ...
        $this->_display('statcenter/pagedetail.phtml');
    }
    ...
    public function productdetailAction(){
        ...
        $query_string = http_build_query($this->input_get());
        $this->renderPagger($page_no, $result['total_nums'], "/store/statcenter/productdetail?$query_string&page_no={p}", $params['page_size']);

        $this->_display('statcenter/productdetail.phtml');
    }
