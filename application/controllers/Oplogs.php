...
class OplogsController extends Base {
    ...
    public function showlistAction() {
        ...
        $oplogs_list = $this->oplogs_model->getlist($showcase_id, $sourceid, $title, $uri, $nickname, $start_time, $end_time, $page_no, $page_size);
        ...
        $this->renderPagger($p, $oplogs_list['total_nums'], "/oplogs/showlist/showcase_id/$showcase_id/page_no/{p}", $page_size);
